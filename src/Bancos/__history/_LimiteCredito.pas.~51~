...
Type
  WebLimiteCredito = record
    produtor_id: Integer;
    limite_credito: Double;
    nome_distribuidor: string;
    distribuidor_id: Integer;
  end;
  TArrayOfWebLimiteCredito = array of WebLimiteCredito;

function BuscarLimiteCreditos(con: TSqlConnection; produtor_id: Integer): TArrayOfWebLimiteCredito;
procedure AtualizarLimiteCredito(con: TSqlConnection; limite_creditos: TArrayOfWebLimiteCredito);
